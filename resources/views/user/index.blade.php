            ...
            @if(count($orders)>0)
              @foreach($orders as $order)
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.order.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:40px;border-radius:30%" data-toggle="tooltip" title="view" data-placement="bottom">
                          <i class="material-icons">adjust</i>
                        </a>
                        <form method="POST" action="{{route('user.order.delete',[$order->id])}}">
                          @csrf
                          @method('delete')
                              <button class="btn btn-danger btn-sm dltBtn" data-id={{$order->id}} style="height:30px; width:40px;border-radius:30%" data-toggle="tooltip" data-placement="bottom" title="Delete">
