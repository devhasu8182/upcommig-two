            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{route('user.change.password.form')}}"><i data-feather="mail"></i><span>Change Password</span></a></li>
                        <li><a  href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                            document.getElementById('logout-form').submit();"><i data-feather="log-in"> </i><span>{{ __('Logout') }}</span></a></li>
