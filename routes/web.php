...
Route::get('/order-confirm', function () {return view('frontend.pages.order-confirm');});
...
Route::get('/terms-and-conditions','FrontendController@termsAndConditions')->name('tc-page');
Route::get('/shipping-and-returns','FrontendController@shippingAndReturns')->name('shipping-and-returns');
